package com.asix.demo.swaggerconfig;
...
public class SwaggerConfiguration {
    ...
    private ApiInfo metadata() {
        return new ApiInfoBuilder().title("ASIX API").description("API reference guide for developers").termsOfServiceUrl("https://www.google.com/").contact("Francis Nweke").version("1.0").build();
    }
}
